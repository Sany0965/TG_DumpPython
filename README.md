...
## Пример интерфейса 🖼️
### Главная страница
![Главная страница](https://TransFiles.ru/ey1y9/1)

### Пример диалога
![Пример диалога](https://TransFiles.ru/ey1y9/2)

## Установка 🛠️

### Скачайте файлы
1. Нажмите на кнопку **Code** вверху страницы репозитория.
2. Выберите **Download ZIP** или используйте команду:
```bash
git clone https://github.com/ваш-репозиторий.git
cd telegram-dialog-exporter
```
